...
$({numberValue: currentNumber}).animate({numberValue: 92.6}, {
duration: 2500,
easing: 'linear',
step: function (now) {
...
$({numberValue: currentNumber}).animate({numberValue: 76.5}, {
duration: 2500,
easing: 'linear',
step: function (now) {
...
$({numberValue: currentNumber}).animate({numberValue:93.8}, {
duration: 2500,
easing: 'linear',
step: function (now) {
